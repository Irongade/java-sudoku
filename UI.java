...
public class UI {
    ...
    public String getChoice() {
        ...
        if (choice.equalsIgnoreCase("M")) {
            ...
            if(!thegame.isMoveValid(row, col, number)) {
                System.out.println("That cell cannot be changed");
                while (!thegame.isMoveValid(row, col, number)) {
                    System.out.print("Which row is the cell you wish to fill?  ");
                    row = reader.next();
                    System.out.print("Which colum is the cell you wish to fill?  ");
                    col = reader.next();
            ...
            // String move = row + "," + col + "," + number;
            Assign move = new Assign(thegame, row, col, number);
            gameStack.add(move);

            System.out.println(gameStack);
                // Assign gameMove = new Assign(this, row, col, number);
    ...
    public void saveGame() {
          try {
            PrintStream gameFileStream = new PrintStream(new File("sudoku.txt"));
    ...
    public void loadGame() {
        try {
            Scanner gameFileScnr = new Scanner(new File("sudoku.txt"));
            clearGame();
